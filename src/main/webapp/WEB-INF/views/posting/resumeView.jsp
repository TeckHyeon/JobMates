...
<div class="row">
    <div class="col-md-4 mt-5">
        <img src="${resumeFile.filePath}" id="imagePreview" style="width:240px; height: 305px;" class="mb-2 border border-tertiary">
    </div>
...
<div class="container" style="width: 100%;">
    <div class="row justify-content-center">
        ...
        <div class="d-flex mt-4 justify-content-center">
            <div class="px-2">
                <a href="/resumeEditForm?resumeIdx=${resume.resumeIdx}" id="edit-resume" class="btn btn-primary">수정하기</a>
            </div>
        </div>
    </div>
</div>
